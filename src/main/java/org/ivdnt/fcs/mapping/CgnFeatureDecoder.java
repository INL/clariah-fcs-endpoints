...
public class CgnFeatureDecoder {
	 ...
	 * 
	 * @param CGN pos tag
	 * @param CGN pdtype feature, used to disambiguate some values for other features
	 * @param Map of possible values for CGN features
	 * @param Map of possible CGN features per CGN POS tag
	...
	public static String getFeatureName(String posTag, String pdtype,
			...
			ConcurrentHashMap<String, HashSet<String>> posTag2FeatureNames,
			String featureValue) {
	...
	public static void main(String[] args) {
		...
		System.out.println(getFeatureName("LID", "", CgnMaps.featureName2FeatureValuesNederlab, CgnMaps.posTag2FeatureNamesNederlab, "onbep"));

		System.out.println("Expected result: vwtype");
		System.out.println(getFeatureName("VNW", "", CgnMaps.featureName2FeatureValuesSonar, CgnMaps.posTag2FeatureNamesSonar, "onbep"));
