...
/**
 * This class constructs a query out of a template for Nederlab querying
 * 
...
public class QueryTemplate {
	...
	/*
	 * static String oldTpl = "{"+ "  \"filter\": {"+ "    \"list\": ["+ "      {"+
	 * "        \"condition\": {"+ "          \"type\": \"cql\","+
	 * "          \"field\": \"NLContent_mtas\","+
	 * "          \"value\": \"_QUERY_\""+ "        }"+ "      }"+ "    ]"+ "  },"+
	 * "  \"response\": {"+ "    \"stats\": true,"+ "    \"documents\": {"+
	 * "      \"number\": _NUMBER_,"+ // = items per page (see
	 * ./nederlab/controller/querybuilder.js) "      \"start\": _START_,"+
	 ...
	 * "    \"mtas\": {"+ "      \"kwic\": ["+ "        {"+
	 * "          \"field\": \"NLContent_mtas\","+ "          \"query\": {"+
	 * "            \"type\": \"cql\","+ "            \"value\": \"_QUERY_\""+
	 * "          },"+ "          \"key\": \"tekst\","+
	 * //"          \"key\": \"_QUERY_\"0,"+ // beware: the 0 belongs here!
	 * "          \"output\": \"token\","+ //"          \"number\": 50, "+
	 * "          \"number\": _NUMBER_, "+ // max inline snippets
	 * "          \"start\": 0,"+ //"          \"prefix\": \"t,pos,lemma\","+
	 ...
	 * + "          \"left\": _CONTEXT_,"+ "          \"right\": _CONTEXT_ "+
	 * "        }"+ "      ]"+ "    }"+ "  },"+ "  \"cache\": true"+ "}";
	 */
